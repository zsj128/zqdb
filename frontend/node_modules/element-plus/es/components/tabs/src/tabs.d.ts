...
declare const tabsProps: {
  ...
  readonly tabPosition: EpPropFinalized<StringConstructor, "left" | "right" | "top" | "bottom", unknown, "top", boolean>;
...
declare const Tabs: _$vue.DefineComponent<ExtractPropTypes<{
  ...
  readonly tabPosition: EpPropMergeType<StringConstructor, "left" | "right" | "top" | "bottom", unknown>;
